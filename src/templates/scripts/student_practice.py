...
#
#
# class StudentPracticeDoneScript(BaseScript):
#
#     template = None  # Template.objects.get(script_code="fec2d982-8922-42bc-ac87-ea1a6c2ecea3")
#
#     @classmethod
...
#         body_content = f'''
#                     Прошу предоставить мне декретный отпуск по беременности
#                     и родам продолжительностью {data['days']} календарных дней в период
#                     с {data['date_from']} и выплатить единовременное пособие.
#             '''
